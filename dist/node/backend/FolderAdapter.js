...
var FolderAdapter = /** @class */ (function (_super) {
    ...
    FolderAdapter.CreateAsync = function (opts) {
        var _this = this;
    ...
    FolderAdapter.prototype.getName = function () {
        return this._wrapped.getName();
    };
    FolderAdapter.prototype.isReadOnly = function () {
        return this._wrapped.isReadOnly();
    };
    FolderAdapter.prototype.supportsProps = function () {
        return this._wrapped.supportsProps();
    };
    FolderAdapter.prototype.supportsSynch = function () {
        return this._wrapped.supportsSynch();
    };
    FolderAdapter.prototype.supportsLinks = function () {
        return false;
    };
    /**
    ...
    FolderAdapter.prototype._initialize = function (cb) {
        var _this = this;
        this._wrapped.exists(this._folder, cred_1.default.Root, function (exists) {
            if (exists) {
                cb();
            }
                ...
                _this._wrapped.mkdir(_this._folder, 0x1ff, cred_1.default.Root, cb);
            }
        });
    };
