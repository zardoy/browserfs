...
var EmscriptenFile = /** @class */ (function (_super) {
    ...
    EmscriptenFile.prototype.statSync = function () {
        try {
            return this._fs.statSync(this._path, false, cred_1.default.Root);
        }
        catch (e) {
            throw convertError(e, this._path);
        }
    ...
    EmscriptenFile.prototype.utimesSync = function (atime, mtime) {
        this._fs.utimesSync(this._path, atime, mtime, cred_1.default.Root);
    };
...
var EmscriptenFileSystem = /** @class */ (function (_super) {
    ...
    EmscriptenFileSystem.CreateAsync = function (opts) {
        var _this = this;
    ...
    EmscriptenFileSystem.isAvailable = function () {
        return true;
    };
    EmscriptenFileSystem.prototype.getName = function () {
        return this._FS.DB_NAME();
    };
    EmscriptenFileSystem.prototype.isReadOnly = function () {
        return false;
    };
    EmscriptenFileSystem.prototype.supportsLinks = function () {
        return true;
    };
    EmscriptenFileSystem.prototype.supportsProps = function () {
        return true;
    };
    EmscriptenFileSystem.prototype.supportsSynch = function () {
        return true;
    };
    EmscriptenFileSystem.prototype.renameSync = function (oldPath, newPath, cred) {
        try {
    ...
    EmscriptenFileSystem.prototype.statSync = function (p, isLstat, cred) {
        try {
            var stats = isLstat ? this._FS.lstat(p) : this._FS.stat(p);
            var itemType = this.modeToFileType(stats.mode);
            return new stats_1.default(itemType, stats.size, stats.mode, stats.atime.getTime(), stats.mtime.getTime(), stats.ctime.getTime());
        }
        catch (e) {
            throw convertError(e, p);
        }
    };
    EmscriptenFileSystem.prototype.openSync = function (p, flag, mode, cred) {
        try {
    ...
    EmscriptenFileSystem.prototype.unlinkSync = function (p, cred) {
        try {
            this._FS.unlink(p);
        }
        catch (e) {
    ...
    EmscriptenFileSystem.prototype.rmdirSync = function (p, cred) {
        try {
            this._FS.rmdir(p);
        }
        catch (e) {
    ...
    EmscriptenFileSystem.prototype.mkdirSync = function (p, mode, cred) {
        try {
    ...
    EmscriptenFileSystem.prototype.readdirSync = function (p, cred) {
        try {
    ...
    EmscriptenFileSystem.prototype.truncateSync = function (p, len, cred) {
        try {
    ...
    EmscriptenFileSystem.prototype.readFileSync = function (p, encoding, flag, cred) {
        try {
    ...
    EmscriptenFileSystem.prototype.writeFileSync = function (p, data, encoding, flag, mode, cred) {
        try {
            if (encoding) {
    ...
    EmscriptenFileSystem.prototype.chmodSync = function (p, isLchmod, mode, cred) {
        try {
    ...
    EmscriptenFileSystem.prototype.chownSync = function (p, isLchown, new_uid, new_gid, cred) {
        try {
    ...
    EmscriptenFileSystem.prototype.symlinkSync = function (srcpath, dstpath, type, cred) {
        try {
    ...
    EmscriptenFileSystem.prototype.readlinkSync = function (p, cred) {
        try {
    ...
    EmscriptenFileSystem.prototype.utimesSync = function (p, atime, mtime, cred) {
        try {
    ...
    EmscriptenFileSystem.prototype.modeToFileType = function (mode) {
        if (this._FS.isDir(mode)) {
            return stats_1.FileType.DIRECTORY;
        }
        else if (this._FS.isFile(mode)) {
            return stats_1.FileType.FILE;
        }
        else if (this._FS.isLink(mode)) {
            return stats_1.FileType.SYMLINK;
        }
        else {
