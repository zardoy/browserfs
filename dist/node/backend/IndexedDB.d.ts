...
export default class IndexedDBFileSystem extends AsyncKeyValueFileSystem {
     ...
     */
    static Create(options: IndexedDBFileSystemOptions, cb: BFSCallback<IndexedDBFileSystem>): void;
    static CreateAsync(opts: IndexedDBFileSystemOptions): Promise<IndexedDBFileSystem>;
