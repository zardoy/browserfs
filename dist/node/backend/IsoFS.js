...
var DirectoryRecord = /** @class */ (function () {
    ...
    DirectoryRecord.prototype.isDirectory = function (isoData) {
        var rv = !!(this.fileFlags() & 2 /* FileFlags.Directory */);
...
var TFEntry = /** @class */ (function (_super) {
    ...
    TFEntry.prototype._longFormDates = function () {
        return !!(this.flags() && 128 /* TFFlags.LONG_FORM */);
    };
    return TFEntry;
}(SystemUseEntry));
/**
...
var IsoFS = /** @class */ (function (_super) {
    ...
    IsoFS.CreateAsync = function (opts) {
        var _this = this;
    ...
    IsoFS.prototype.openSync = function (p, flags, mode) {
        ...
        if (!record) {
            ...
            var data = !record.isDirectory(this._data) ? record.getFile(this._data) : undefined;
    ...
    IsoFS.prototype._getStats = function (p, record) {
        if (record.isSymlink(this._data)) {
            ...
            mode = mode & 0x16d;
            return new stats_1.default(record.isDirectory(this._data) ? stats_1.FileType.DIRECTORY : stats_1.FileType.FILE, len, mode, atime, mtime, ctime);
        }
    };
    IsoFS.Name = 'IsoFS';
    IsoFS.Options = {
