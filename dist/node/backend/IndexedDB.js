...
var IndexedDBFileSystem = /** @class */ (function (_super) {
     ...
     */
    IndexedDBFileSystem.Create = function (options, cb) {
        if (!options) {
            options = {
                storeName: 'browserfs',
                cacheSize: 100,
        ...
        IndexedDBStore.Create(options.storeName || 'browserfs', function (e, store) {
            if (store) {
                var idbfs_1 = new IndexedDBFileSystem(options.cacheSize || 100);
    ...
    IndexedDBFileSystem.CreateAsync = function (opts) {
        var _this = this;
