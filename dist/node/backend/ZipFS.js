...
var CentralDirectory = /** @class */ (function () {
    ...
    */
    ...
    CentralDirectory.prototype.getStats = function () {
        return new stats_1.default(stats_1.FileType.FILE, this.uncompressedSize(), 0x16d, Date.now(), this.lastModFileTime().getTime());
    };
...
var EndOfCentralDirectory = /** @class */ (function () {
    ...
    EndOfCentralDirectory.prototype.cdZipCommentLength = function () {
...
var ZipFS = /** @class */ (function (_super) {
    ...
    ZipFS.CreateAsync = function (opts) {
        var _this = this;
    ...
    ZipFS.prototype.openSync = function (path, flags, mode) {
        ...
        else if ((0, file_index_1.isFileInode)(inode) || (0, file_index_1.isDirInode)(inode)) {
            var stats = !(0, file_index_1.isDirInode)(inode) ? inode.getData().getStats() : inode.getStats();
            var data = !(0, file_index_1.isDirInode)(inode) ? inode.getData().getData() : inode.getStats().fileData;
            switch (flags.pathExistsAction()) {
                case file_flag_1.ActionType.THROW_EXCEPTION:
                case file_flag_1.ActionType.TRUNCATE_FILE:
                    throw api_error_1.ApiError.EEXIST(path);
                case file_flag_1.ActionType.NOP:
                    return new preload_file_1.NoSyncFile(this, path, flags, stats, data || undefined);
                default:
...
ZipFS.RegisterDecompressionMethod(CompressionMethod.DEFLATE, function (data, compressedSize, uncompressedSize) {
    return (0, zlib_1.inflateRawSync)(data.slice(0, compressedSize), { chunkSize: uncompressedSize });
});
