...
if (!buffer_1.Buffer.isEncoding(binaryEncoding)) {
...
var LocalStorageStore = /** @class */ (function () {
    ...
    LocalStorageStore.prototype.get = function (key) {
        try {
            var data = globalThis.localStorage.getItem(key);
            if (data !== null) {
                return buffer_1.Buffer.from(data, binaryEncoding);
            }
        }
        catch (e) {
            // Do nothing.
...
var LocalStorageFileSystem = /** @class */ (function (_super) {
    ...
    LocalStorageFileSystem.CreateAsync = function (opts) {
        var _this = this;
