...
var dropbox_bridge_actual_1 = require("../generic/dropbox_bridge_actual");
...
var DropboxFileSystem = /** @class */ (function (_super) {
     ...
     * Must be given an *authenticated* Dropbox client from 2.x JS SDK.
     */
    DropboxFileSystem.CreateAsync = function (opts) {
        var _this = this;
    ...
    DropboxFileSystem.isAvailable = function () {
        ...
        return typeof dropbox_bridge_actual_1.Dropbox !== 'undefined';
    };
    ...
    DropboxFileSystem.prototype.empty = function (mainCb) {
        var _this = this;
        this.readdir('/', cred_1.default.Root, function (e, paths) {
            if (paths) {
    ...
    DropboxFileSystem.prototype.rename = function (oldPath, newPath, cred, cb) {
        var _this = this;
        // Dropbox doesn't let you rename things over existing things, but POSIX does.
        // So, we need to see if newPath exists...
        this.stat(newPath, false, cred, function (e, stats) {
            var rename = function () {
                var relocationArg = {
            ...
            if (e) {
                ...
                _this.unlink(newPath, cred, function (e) {
                    if (e) {
                        cb(e);
                    }
                    else {
    ...
    DropboxFileSystem.prototype.stat = function (path, isLstat, cred, cb) {
        if (path === '/') {
            // Dropbox doesn't support querying the root directory.
            (0, setImmediate_1.default)(function () {
                cb(null, new stats_1.default(stats_1.FileType.DIRECTORY, 4096));
            });
            return;
        }
        var arg = {
        ...
        this._client
            ...
            switch (ref['.tag']) {
                case 'file':
                    ...
                    cb(null, new stats_1.default(stats_1.FileType.FILE, fileMetadata.size));
                    break;
                case 'folder':
                    cb(null, new stats_1.default(stats_1.FileType.DIRECTORY, 4096));
                    break;
    ...
    DropboxFileSystem.prototype.openFile = function (path, flags, cred, cb) {
        var _this = this;
        var downloadArg = {
            path: FixPath(path),
        };
        this._client
            ...
            fr.onload = function () {
                var ab = fr.result;
                cb(null, new DropboxFile(_this, path, flags, new stats_1.default(stats_1.FileType.FILE, ab.byteLength), (0, util_1.arrayBuffer2Buffer)(ab)));
            };
    ...
    DropboxFileSystem.prototype.createFile = function (p, flags, mode, cred, cb) {
        var _this = this;
        var fileData = buffer_1.Buffer.alloc(0);
        ...
        this._client
            ...
            cb(null, new DropboxFile(_this, p, flags, new stats_1.default(stats_1.FileType.FILE, 0), fileData));
        })
            .catch(function (e) {
            var err = ExtractTheFuckingError(e);
            ...
            switch (err['.tag']) {
                ...
                case 'too_many_write_operations':
                    // Retry in (500, 800) ms.
                    setTimeout(function () { return _this.createFile(p, flags, mode, cred, cb); }, 500 + 300 * Math.random());
                    break;
                case 'other':
                default:
                    cb(new api_error_1.ApiError(api_error_1.ErrorCode.EIO, GetErrorMessage(e), p));
     ...
     * Delete a file
     */
    DropboxFileSystem.prototype.unlink = function (path, cred, cb) {
        var _this = this;
        // Must be a file. Check first.
        this.stat(path, false, cred, function (e, stat) {
            if (stat) {
                if (stat.isDirectory()) {
     ...
     * Delete a directory
     */
    DropboxFileSystem.prototype.rmdir = function (path, cred, cb) {
        var _this = this;
        this.readdir(path, cred, function (e, paths) {
            if (paths) {
                if (paths.length > 0) {
     ...
     * Create a directory
     */
    DropboxFileSystem.prototype.mkdir = function (p, mode, cred, cb) {
        var _this = this;
        // Dropbox's create_folder is recursive. Check if parent exists.
        var parent = (0, path_1.dirname)(p);
        this.stat(parent, false, cred, function (e, stats) {
            if (e) {
                cb(e);
            }
            else if (stats && !stats.isDirectory()) {
                ...
                _this._client
                    ...
                    if (err['.tag'] === 'too_many_write_operations') {
                        // Retry in a bit.
                        setTimeout(function () { return _this.mkdir(p, mode, cred, cb); }, 500 + 300 * Math.random());
                    }
                    else {
     ...
     */
    DropboxFileSystem.prototype.readdir = function (path, cred, cb) {
        var _this = this;
        var arg = {
            path: FixPath(path),
        };
