            ...
            if (req.status === 200) {
                switch (type) {
                    case 'buffer':
                        ...
                        return cb(null, req.response ? buffer_1.Buffer.from(req.response) : (0, util_1.emptyBuffer)());
                    case 'json':
                        if (jsonSupported) {
            ...
            if (req.status === 200) {
                switch (type) {
                    case 'buffer':
                        ...
                        data = buffer_1.Buffer.alloc(text.length);
    ...
    req.onreadystatechange = function (e) {
        if (req.readyState === 4) {
            if (req.status === 200) {
                switch (type) {
                    case 'buffer':
                        data = buffer_1.Buffer.from(req.response);
                        break;
                    case 'json':
