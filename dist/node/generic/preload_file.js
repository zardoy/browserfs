...
var PreloadFile = /** @class */ (function (_super) {
    ...
    PreloadFile.prototype.stat = function (cb) {
        try {
            cb(null, stats_1.default.clone(this._stat));
        }
        catch (e) {
            cb(e);
        }
    ...
    PreloadFile.prototype.statSync = function () {
        return stats_1.default.clone(this._stat);
    };
    /**
    ...
    PreloadFile.prototype.truncateSync = function (len) {
        ...
        if (len > this._buffer.length) {
            var buf = buffer_1.Buffer.alloc(len - this._buffer.length, 0);
        ...
        var newBuff = buffer_1.Buffer.alloc(len);
    ...
    PreloadFile.prototype.writeSync = function (buffer, offset, length, position) {
        ...
        if (endFp > this._stat.size) {
            ...
            if (endFp > this._buffer.length) {
                // Extend the buffer!
                var newBuff = buffer_1.Buffer.alloc(endFp);
     ...
     * @param [Function(BrowserFS.ApiError)] cb
     */
    PreloadFile.prototype.chown = function (uid, gid, cb) {
        try {
     ...
     * @param [Number] gid
     */
    PreloadFile.prototype.chownSync = function (uid, gid) {
        if (!this._fs.supportsProps()) {
            throw new api_error_1.ApiError(api_error_1.ErrorCode.ENOTSUP);
        }
        this._dirty = true;
