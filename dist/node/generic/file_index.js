...
var FileIndex = /** @class */ (function () {
            ...
            for (var node in tree) {
                if (Object.prototype.hasOwnProperty.call(tree, node)) {
                    ...
                    if (children) {
                        ...
                        inode = new FileInode(new stats_1.default(stats_1.FileType.FILE, -1, 0x16d));
                    }
                    if (parent_1) {
    ...
    FileIndex.prototype.fileIterator = function (cb) {
        for (var path_1 in this._index) {
            if (Object.prototype.hasOwnProperty.call(this._index, path_1)) {
...
var FileInode = /** @class */ (function () {
    ...
    FileInode.prototype.toStats = function () {
        return new stats_1.default(stats_1.FileType.FILE, 4096, 438);
    };
    return FileInode;
}());
...
var DirInode = /** @class */ (function () {
    ...
    DirInode.prototype.getData = function () {
        return this.data;
    };
    /**
    ...
    DirInode.prototype.getStats = function () {
        return new stats_1.default(stats_1.FileType.DIRECTORY, 4096, 365);
    };
    /**
     * Alias of getStats()
     ...
     *       responsibility of the FileIndex.
     */
    DirInode.prototype.toStats = function () {
