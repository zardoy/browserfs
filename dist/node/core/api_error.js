...
var ApiError = /** @class */ (function (_super) {
    ...
    ApiError.fromJSON = function (json) {
        var err = new ApiError(json.errno, json.message, json.path);
        err.code = json.code;
    ...
    ApiError.prototype.writeToBuffer = function (buffer, i) {
        if (buffer === void 0) { buffer = buffer_1.Buffer.alloc(this.bufferSize()); }
        if (i === void 0) { i = 0; }
    ...
    ApiError.prototype.bufferSize = function () {
        ...
        return 4 + buffer_1.Buffer.byteLength(JSON.stringify(this.toJSON()));
    };
    return ApiError;
}(Error));
