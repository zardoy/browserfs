...
var FS = /** @class */ (function () {
     ...
     * @returns
     */
    FS.prototype.initialize = function (rootFS, cred) {
    ...
    FS.prototype.open = function (path, flag, arg2, cb) {
        ...
        var newCb = wrapCb(cb, 2);
        try {
            assertRoot(this.root).open(normalizePath(path), file_flag_1.FileFlag.getFileFlag(flag), mode, this.cred, function (e, file) {
                if (file) {
    ...
    FS.prototype.openSync = function (path, flag, mode) {
        ...
        return this.getFdForFile(assertRoot(this.root).openSync(normalizePath(path), file_flag_1.FileFlag.getFileFlag(flag), normalizeMode(mode, 0x1a4), this.cred));
    };
    ...
    FS.prototype.write = function (fd, arg2, arg3, arg4, arg5, cb) {
        ...
        if (typeof arg2 === 'string') {
            ...
            buffer = buffer_1.Buffer.from(arg2, encoding);
            offset = 0;
    ...
    FS.prototype.read = function (fd, arg2, arg3, arg4, arg5, cb) {
        ...
        if (typeof arg2 === 'number') {
            ...
            cb = typeof arg5 === 'function' ? arg5 : cb;
            offset = 0;
            buffer = buffer_1.Buffer.alloc(length);
            // XXX: Inefficient.
    ...
    FS.prototype.access = function (path, arg2, callback) {
        if (callback === void 0) { callback = nopCb; }
        var mode = typeof arg2 === 'number' ? arg2 : stats_1.FilePerm.READ;
