 ...
 */
export declare function initialize(rootfs: FileSystem, uid?: number, gid?: number): FileSystem;
/**
 ...
 */
export declare function configureAsync(config: FileSystemConfiguration): Promise<FileSystem | Errors.ApiError | null>;
/**
