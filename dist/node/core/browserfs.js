...
exports.setImmediate = exports.Errors = exports.FileSystem = exports.EmscriptenFS = exports.getFileSystem = exports.configureAsync = exports.configure = exports.initialize = exports.BFSRequire = exports.registerFileSystem = exports.install = void 0;
 ...
 */
function initialize(rootfs, uid, gid) {
    if (uid === void 0) { uid = 0; }
    if (gid === void 0) { gid = 0; }
    var cred = new cred_1.default(uid, gid, uid, gid, uid, gid);
    return node_fs_1.default.initialize(rootfs, cred);
}
 ...
 */
function configureAsync(config) {
