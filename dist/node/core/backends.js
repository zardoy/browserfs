...
var FileSystemAccess_1 = require("../backend/FileSystemAccess");
...
[AsyncMirror_1.default, Dropbox_1.default, Emscripten_1.default, FileSystemAccess_1.default, FolderAdapter_1.default, InMemory_1.default, IndexedDB_1.default, IsoFS_1.default, LocalStorage_1.default, MountableFileSystem_1.default, OverlayFS_1.default, WorkerFS_1.default, HTTPRequest_1.default, ZipFS_1.default].forEach(function (fsType) {
 ...
 */
var Backends = {
    AsyncMirror: AsyncMirror_1.default,
    Dropbox: Dropbox_1.default,
    Emscripten: Emscripten_1.default,
    FileSystemAccess: FileSystemAccess_1.default,
    FolderAdapter: FolderAdapter_1.default,
    InMemory: InMemory_1.default,
    IndexedDB: IndexedDB_1.default,
    IsoFS: IsoFS_1.default,
    LocalStorage: LocalStorage_1.default,
    MountableFileSystem: MountableFileSystem_1.default,
    OverlayFS: OverlayFS_1.default,
    WorkerFS: WorkerFS_1.default,
    HTTPRequest: HTTPRequest_1.default,
    XmlHttpRequest: HTTPRequest_1.default,
    ZipFS: ZipFS_1.default,
};
