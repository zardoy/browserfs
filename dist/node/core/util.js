...
exports.checkOptions = exports.bufferValidator = exports.emptyBuffer = exports.copyingSlice = exports.arrayBuffer2Buffer = exports.uint8Array2Buffer = exports.buffer2Uint8array = exports.buffer2ArrayBuffer = exports.mkdirpSync = exports.fail = exports.isWebWorker = exports.isIE = exports.deprecationMessage = void 0;
 ...
 * @hidden
 */
function mkdirpSync(p, mode, cred, fs) {
...
function uint8Array2Buffer(u8) {
    if (u8 instanceof buffer_1.Buffer) {
        return u8;
    }
        ...
        return buffer_1.Buffer.from(u8.buffer, u8.byteOffset, u8.byteLength);
    }
}
...
function arrayBuffer2Buffer(ab) {
    return buffer_1.Buffer.from(ab);
}
...
function emptyBuffer() {
    ...
    return (emptyBuff = buffer_1.Buffer.alloc(0));
}
...
function checkOptions(fsType, opts, cb) {
    ...
    var _loop_1 = function (optName) {
        if (Object.prototype.hasOwnProperty.call(optsInfo, optName)) {
            ...
            var providedValue = opts && opts[optName];
            if (providedValue === undefined || providedValue === null) {
                if (!opt.optional) {
                    ...
                    var incorrectOptions = Object.keys(opts)
                        .filter(function (o) { return !(o in optsInfo); })
                        .map(function (a) {
                        return { str: a, distance: (0, levenshtein_1.default)(optName, a) };
                    })
                        .filter(function (o) { return o.distance < 5; })
